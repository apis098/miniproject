...
{
    use HasFactory;
    protected $fillable = ['reply_id_comment','like_reply_id','user_id', 'follower_id','like_id','complaint_id','notification_from','alasan','reply_id','status','reply_id_report','complaint_id_report','resep_id'];
