    ...
    <div class=" d-flex justify-content-center ms-3">
        <div class="my-5 ml-5" style="margin-right: -15%;">
            <ul class="nav mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a href="{{route('Report.profil')}}"  class="nav-link mr-5 yuhu mt-2 active"
                       type="button"
                        aria-selected="false">
                        <h5 class="text-dark ms-2" style="font-weight: 600; word-wrap: break-word;">
                            Laporan profile
                        ...
                        <div id="border1" class="ms-2" style="width: 90%; height: 100%; border: 1px #F7941E solid;">
                        </div>
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content mb-5 mx-3" id="pills-tabContent">
                ...
                <div class="" id="pills-user" role="tabpanel" aria-labelledby="pills-contact-tab"
                    tabindex="0">
                    <form action="">
                                    ...
                                    <div class="col-md-12">
                                        <div>
                                            <div class="search-2"> <i class='bx bxs-map'></i>
                                                <form action="/admin/profil" method="GET">
    ...
    <script>
        ...
        function buttonAllert(num) {
            iziToast.show({
                ...
                titleColor: 'white',
                messageColor: 'white',
                message: 'Anda yakin ingin memblokir pengguna tersebut?',
                position: 'topCenter',
                close:false,
                progressBarColor: 'white',
                buttons: [
        ...
        function confirmation(num) {
            iziToast.show({
                ...
                titleColor: 'white',
                messageColor: 'white',
                message: 'Anda yakin ingin menghapus laporan?',
                position: 'topCenter',
                close:false,
                progressBarColor: 'white',
                buttons: [
