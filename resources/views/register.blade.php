                                    ...
                                    <input type="password" name="password" id="pass2" class=" username form-control rounded-4"
                                        ...
                                        <div class="input-group-append eye1">
                                          ...
                                          <span id="mybutton2" onclick="change('pass2','mybutton2')">
                                              ...
                                              <svg  width="1.1em" height="1.8em" viewBox="0 0 16 16" class="bi bi-eye-fill" fill="currentColor"
                                                  xmlns="http://www.w3.org/2000/svg">
          ...
          function change(inputId, buttonId) {
            ...
            var button = document.getElementById(buttonId);
              ...
              if (input.type === 'password') {
                input.type = 'text';
                button.innerHTML = `<svg width="1.1em" height="1.8em" viewBox="0 0 16 16" class="bi bi-eye-slash-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                input.type = 'password';
                button.innerHTML = `<svg width="1.1em" height="1.8em" viewBox="0 0 16 16" class="bi bi-eye-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/>
