            ...
            <div class="sidebar">
                ...
                <li class="nav-item" style="margin-bottom: -30px; margin-top: 2em">
                    <a href="{{ route('admin.kursus') }}"   
                        class="nav-link mx-4 {{ request()->is('admin/kursus') ? 'activet text-orange' : 'text-white' }}" style="width: 12em">
                    ...
                    <a href="{{ route('admin.tawaran') }}"
                        class="nav-link mx-4 {{ request()->is('admin/tawaran') ? 'activet text-orange' : 'text-white' }}" style="width: 12em">
