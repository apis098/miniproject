...
@section('konten')
    ...
    <div style="overflow-x: hidden">
        ...
        <div class="tab-content" id="pills-tabContent">
                ...
                <form action="{{ route('upload.tawaran') }}" method="post" id="form-upload-tawaran">
                    ...
                    <div class=" d-flex justify-content-start ms-3" style="overflow-x:hidden;">
                        <div class=" ml-5">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="durasi" name="durasi_paket" class="form-control "
                                        style="  width: 50rem; margin-left:-15px "
                            ...
                            <div id="details"></div>
                            <button type="button" id="button-add-detail"
                                class="btn text-light rounded-3 mt-4 mb-3 float-start"
                                    ...
                                    <div class="pricing-item animated-card">
                                        <div class="pricing-heading">
                                            <button type="button "
                                                ...
                                                class="btn btn-lg text-light rounded-circle " data-toggle="modal"
                                                data-target="#edit">
            ...
            <div class="tab-pane fade show" id="topUp" role="tabpanel" aria-labelledby="pills-home-tab"
                tabindex="0">
                    ...
                    <div class="row">
                            ...
                            <table id="table-resep" class="table-custom" style="width: 90%;">
                                ...
                                <tbody>
                                    @foreach ($categoryTopUp as $topup)
                                        ...
                                        <div class="modal fade" id="modalEdit{{ $topup->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered " role="document">
                                                <div class="modal-content" style="border-radius: 15px">
                                                    <div class="modal-body">
                                                        ...
                                                        <br>
                                                        <form action="{{ route('update.categories', $topup->id) }}"
                                                            method="POST">
                                                            @method('PUT')
                                                            @csrf
                                                            <div class="">
                        ...
                        <div class="row mx-1">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#modalTambah"
                                class="btn rounded-3 text-dark mx-5" style="border: 1px solid #000; width:90%"><b
                                    class="">
                                    Tambah
                            </button>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class=" d-flex mb-3 ">
                                                ...
                                                <div class="col-sm-11">
                                                    <input type="text" id="nama_topup" name="name"
                                                        class="form-control" style="border-radius: 10px" placeholder="Masukkan Nama Kategori...">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class=" d-flex mb-3">
                                                ...
                                                <div class="col-sm-11">
                                                    <input type="text" id="harga_topup" name="price"
                                                        class="form-control"  style="border-radius: 10px"  placeholder="Masukkan Harga default...">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="mb-3 row ml-1">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" id="nama" name="nama_paket"
                                                        class="form-control" style="  width: 38rem; margin-left:-15px "
