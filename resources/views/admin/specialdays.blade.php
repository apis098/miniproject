    ...
    <div class=" d-flex" style="margin-left: 20%;">
        <div class="tab-content mb-5 mx-3" id="pills-tabContent">
            <div class="my-5" style="margin-right:%;">
                ...
                style=" border-radius: 10px; border: 0.50px black solid; font-size: 18px; font-family: Poppins; font-weight: 500; letter-spacing: 0.20px; word-wrap: break-word; margin-left: -40%;"     data-target="#exampleModal">Tambah</button>
                <form action="">
