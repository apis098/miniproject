        ...
        <div class="scrollbar" style="overflow-x:scroll;">
            <table id="table-resep" class="table-custom ml-auto" style="min-width: 400px;">
                ...
                <tbody id="search-results">
                    @foreach ($special_days as $num => $data)
                        <tr class="mt-5">
                            <td style="border-left:1px solid black;">
                                {{ Str::limit($data->nama, 17, '...') }}
                            </td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content" style="border-radius: 15px">
                                            <div class="modal-body">
                                                ...
                                                <br>
                                                <form action="{{ route('special-days.update', $data->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    ...
                                                    <div class="">
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control"
                                                                value="{{ $data->nama }}" name="nama" id="nama"
                                            ...
                                            <form action="{{ route('special-days.destroy', $data->id) }}" method="post">
                                                ...
                                                <div class="modal-body row d-flex align-items-center col-12">
                                                    ...
                                                    <div class="col-10">
                                                        ...
                                                        <p class="ml-4">
                                                            Apakah anda yakin mau menghapus hari khusus ini?
                                                        </p>
                                                    </div>
                                                </div>
