...
@section('konten')
                        ...
                        <tbody>
                            ...
                            <div id="search-results">
                                <tr class="mt-5">
                                    ...
                                    <td style=" font-size: 20px; font-family: Poppins; font-weight: 500; letter-spacing: 0.40px; word-wrap: break-word""><a href="#" class="text-black"  data-toggle="modal"
                                        data-target="#modalKursus"> Cara Memanggang</a></td>
    ...
    {{-- modal kursus --}}
    <div class="modal fade bd-example-modal-xl rounded-5" id="modalKursus" tabindex="-1"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col lg-6 mb-5 my-3">
                                    ...
                                    <br>
                                    <br>
                                    <p style=" color: black; font-size: 25px; font-family: Poppins; font-weight: 700; word-wrap: break-word"><b> Cara memanggang yang baik dan benar </b></p>
                                    <div class="my-3 mt-5">
                                        <h3 class="mb-3" style=" color: black; font-size: 24px; font-family: Poppins; font-weight: 600; word-wrap: break-word"><b>Tentang kursus</b></h3>
                                    ...
                                    <div class=" mt-3">
                                        <h3  style=" color: black; font-size: 24px; font-family: Poppins; font-weight: 600; word-wrap: break-word"><b>Lokasi kursus</b></h3>
                                        <button type="button" class="btn mt-3" style=" border-radius: 12px; border: 1px black solid">
                                ...
                                <div class="col-xl-3 col-sm-4 mb-4 my-5">
                                    <div class="bg-white shadow-sm py-5 border border-secondary text-center"
                                        ...
                                        <h5 class="mb-0">
                                            <a href="#" style=" color: black; font-size: 20px; font-family: Poppins; font-weight: 600; word-wrap: break-word">
                                                Kamisato Ayaka
                                            </a>
                                        </h5>
                            ...
                            <div class="my-5 mt-4">
                                <h3  style=" color: black; font-size: 24px; font-family: Poppins; font-weight: 600; word-wrap: break-word"><b>Tarif per jam</b></h3>
                            </div>

                            <div class="card mb-5" style="width: 77%;margin-top:-15px;border-radius:15px;  border: 1px black solid">
