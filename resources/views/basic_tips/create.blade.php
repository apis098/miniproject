...
<div class="row">
    <div class="col-md-7">
        <form method="POST" action="{{ route('BasicTips.store') }}">
            @csrf
            <div class="form-group mb-3">
              <label for="name" class="mb-2">Nama Tips Dasar</label>
              <input type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp" placeholder="Masukkan nama Tips...">
            </div>
            <div class="form-group mb-3">
