...
<main class="page fade-in">
	...
	<div class="flex-container" id="error-message">
		<div>
			<h1>405</h1>
			<h2 style="font-family: Poppins;">Mhethod Not Alowed</h2>
		</div>
		<div>
			<p style="font-family: Poppins;">
				Method tidak valid` <span class="underlined">, Silakan kembali ke halaman sebelumnya</span>. Atau membunuh kutu sebanyak banyaknya dengan senjatamu
			</p>
		</div>
	</div>
	<div id="game-canvas">
