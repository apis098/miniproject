...
<main class="page fade-in">
	...
	<div class="flex-container" id="error-message">
		<div>
			<h1>503</h1>
			<h2 style="font-family: Poppins;">Service Unavailable</h2>
		</div>
		<div>
			<p style="font-family: Poppins;">
				Permintaan sedang tidak dapat lakukan<span class="underlined">, Silakan Kembali dan mencoba lagi</span>. Atau bunuh kutu sebanyak banyaknya dengan senjatamu.
			</p>
		</div>
	</div>
	<div id="game-canvas">
...
<!-- partial -->
  ...
  <script  src="{{asset('Errors/script.js')}}"></script>
  <script>
    let countDown = 30;
