...
<main class="page fade-in">
	...
	<div class="flex-container" id="error-message">
		<div>
			<h1>403</h1>
			<h2 style="font-family: Poppins;">Forbidden</h2>
		</div>
		<div>
			<p style="font-family: Poppins;">
				Halaman tidak dapat di akses <span class="underlined">, Silakan kembali ke halaman sebelumnya</span>. Atau membunuh kutu sebanyak banyaknya dengan senjatamu
			</p>
		</div>
	</div>
	<div id="game-canvas">
