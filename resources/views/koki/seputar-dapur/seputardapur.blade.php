...
@section('konten')
    ...
    <div class="container mb-3 mt-1 mb-md-1">
                ...
                <tbody class="table-active border-light">
                    @foreach ($seputar_dapur as $data)
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('storage/public/seputardapur/' . $data->foto) }}" class="card-img-top"
                                    alt="${{ $data->foto }}" style="width:90px">
                            </td>
                            <td>{{ $data->judul }}</td>
                            ...
                            <td>
                                ...
                                <form action="{{ route('seputar_dapur.destroy', $data->id) }}" method="POST"
        ...
        @foreach ($seputar_dapur as $item)
            @if ($item->id != '')
                {{-- modal edit --}}
                <div class="modal fade bd-example-modal-lg" id="exampleModal{{ $item->id }}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('seputar_dapur.update', $item->id) }}" method="POST"
                                ...
                                @enderror name="foto"
                                            ...
                                            <img src="{{ asset('storage/public/seputardapur/' . $item->foto) }}"
