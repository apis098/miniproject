            ...
            <div class="tab-content mb-5 mx-" id="pills-tabContent">
                ...
                <div class="text-center mt-4">
                    <div style="position: relative; display: inline-block;">
                        @if ($userLogin->foto)
                            <img src="{{ asset('storage/' . $userLogin->foto) }}" width="200px" height="200px" style="border-radius: 50%"
                                alt="">
                        @else
                            <img src="{{ asset('images/default.jpg') }}" width="200px" height="200px" style="border-radius: 50%"
                                alt="">
                        @endif
                        <button type="submit"
                    ...
                    <form action="{{ route('update.profile') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="nama" name="name" value="{{ $userLogin->name }}" class="form-control rounded-2 "
                                    style=" width: 100%;  " placeholder="Masukkan Nama...">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="durasi" name="biodata" value="{{-- $userLogin->password --}}"
                                    class="form-control rounded-2" style=" width: 100%;  " placeholder="Masukkan Biodata..." rows="3"></textarea>
                            </div>
                        </div>
                ...
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                    ...
                    <div class="mb-3 row mt-2">
                        ...
                        <div class="col-sm-9">
                            <input type="password" id="oldpass" name="password" value="{{-- $userLogin->name --}}" class="form-control rounded-2 "
                                style=" width: 100%; " placeholder="Masukkan password...">
                    ...
                    <div class="mb-3 row mt-2">
                        ...
                        <div class="col-sm-9">
                            <input type="password" id="newpass" name="newpass" value="{{-- $userLogin->name --}}" class="form-control rounded-2"
                                style=" width: 100%;  " placeholder="Masukkan password baru...">
                        </div>
                    </div>
                    <div class="mb-3 row mt-2">
                        <label class="col-sm-2 col-form-label fw-bold mx-3">konfirmasi password</label>
                        <div class="col-sm-9">
                            <input type="password" id="copassword" name="copassword" value="{{-- $userLogin->name --}}" class="form-control rounded-2"
                                style=" width: 100%;  " placeholder="konfirmasi password...">
                        </div>
                    </div>
