                ...
                <tbody class="table-active border-light">
                    @foreach ($basic_tips as $data)
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('storage/public/tipsdasar/' . $data->foto) }}" class="card-img-top"
                                    alt="{{ $data->foto }}" style="width:90px">
                            </td>
                            <td>{{ strlen($data->deskripsi) > 15 ? Str::limit($data->deskripsi, 15) . '...' : $data->deskripsi }}
                            </td>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        @enderror
                                            ...
                                            @foreach ($kategori_tipsdasar as $data)
                                                <option {{ $data->id ? 'selected' : '' }} value="{{ $data->id }}">
                                                    {{ $data->nama_kategori }}
                                                </option>
                                            @endforeach
                                        </select>
