                                    ...
                                    <div class="col-lg-12">
                                        <div class="search-2"><i class='bx bxs-map'></i>
                                            <form action="#" method="GET">
                                                ...
                                                <button type="button" class="zoom-effects" onclick="cariResepDibuat()"
                    ...
                    <div class="mx-1 my-4">
                        ...
                        <div class="row" id="resepDibuat">
                            @foreach ($resep_dibuat as $num => $my_recipe)
                                <div class="col-lg-3 col-md-6 col-sm-12 mb-4 resepDibuat">
                                    <div class="card-body" style="border-radius: 15px; border: 0.50px black solid">
                                        <div class=" my-3 mx-auto" style="background-color: white">
                                            ...
                                            <img class="rounded-circle mb-2"
                                                style="border: 0.50px black solid; width: 100%;"
                                                src="{{ asset('storage/' . $my_recipe->foto_resep) }}" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-2">
                                                    ...
                                                    {{ $my_recipe->comment_recipes()->count() }} Komen
                                                </div>
                                                <div class="col-6 mb-2">
                                                    <svg width="14" height="23" viewBox="0 0 24 33"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    {{ $my_recipe->favorite()->count() }} Favorit
                                                </div>
                                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="search" style="border-radius: 15px; border: 0.50px black solid;">
                                    <div class="col-lg-12">
                                        <div class="search-2"><i class='bx bxs-map'></i>
                                            <form action="#" method="GET">
                                                <input type="text" id="nama_resep_disukai" name="profil" placeholder="Search For Something">
                    ...
                    <div class="mx-1 my-4">
                        ...
                        <div class="row">
                            @foreach ($resep_disukai as $num => $suka)
                                <div class="col-lg-3 col-md-6 col-sm-12 mb-4 resepDisukai">
                                    <div class="card-body" style="border-radius: 15px; border: 0.50px black solid">
                                        <div class=" my-3 mx-auto" style="background-color: white">

                                            <img class="rounded-circle mb-2"
                                                style="border: 0.50px black solid; width: 100%;"
                                                src="{{ asset('storage/' . $suka->foto_resep) }}" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-2">
                                                    ...
                                                    {{ $suka->comment_recipes()->count() }} Komen
                                                </div>
                                                <div class="col-6 mb-2">
                                                    <svg width="14" height="23" viewBox="0 0 24 33"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="search" style="border-radius: 15px; border: 0.50px black solid;">
                                    <div class="col-lg-12">
                                        <div class="search-2"><i class='bx bxs-map'></i>
                                            <form action="#" method="GET">
                                                <input type="text" id="nama_resep_favorite" name="profil" placeholder="Search For Something">
                                                <button type="submit" class="zoom-effects"
                                                    style="border-radius: 15px; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); margin-right: -17px">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                        viewBox="0 0 256 256">
                    ...
                    <div class="mx-1 my-4">
                        ...
                        <div class="row">
                            @foreach ($resep_favorite as $num => $favorite)
                                <div class="col-lg-3 col-md-6 col-sm-12 mb-4 resepFavorite">
                                    <div class="card-body" style="border-radius: 15px; border: 0.50px black solid">
                                        <div class=" my-3 mx-auto" style="background-color: white">

                                            <img class="rounded-circle mb-2"
                                                style="border: 0.50px black solid; width: 100%;"
                                                src="{{ asset('storage/' . $favorite->foto_resep) }}" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-2">
                                                    ...
                                                    {{ $favorite->comment_recipes()->count() }} Komen
                                                </div>
                                                <div class="col-6 mb-2">
                                                    <svg width="14" height="23" viewBox="0 0 24 33"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    {{ $favorite->favorite()->count() }} Favorit
                                                </div>
                                            </div>
