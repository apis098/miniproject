  ...
  <div class="">
    <div class="my-4">
      <ul class="nav mb-2 ul_kursus" id="pills-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <a id="fer" class="nav-link" id="pills-kita-tab" data-bs-toggle="pill" data-bs-target="#pills-kita"
            type="button" role="tab" aria-controls="pills-kita" aria-selected="false">
