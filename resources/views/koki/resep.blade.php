...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-3 mb-5">
                <div class="card my-5">
                    <div class="card-body text-center">
                        <img src="" width="" alt="" class=""><svg width="102" height="137"
                            viewBox="0 0 102 137" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="row"
                    ...
                    <button type="button" onclick="klik0()" class="col-4"
                        ...
                        <div
                            ...
                            Pilih File</div>
                        <input class="form-control my-auto mx-1" style="display: none;" type="file" id="formFile0">
                    </button>
                    <div class="col-8" id="infos0"
            ...
            <div class="col-lg-9">
                ...
                <div class="mt-2">
                    ...
                    <textarea class="form-control" placeholder="Masukkan deskripsi makanan" id="floatingTextarea"></textarea>
                </div>
                <div class="mt-2">
                ...
                <div class="mt-2">
                    ...
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan takaran">
                    <br>
                </div>
                <button class="btn btn-warning text-white" style="float: right;background: #F7941E;">Tambahkan</button> <br>
                <div class="mt-2">
                ...
                <div class="mt-2">
                    ...
                    <input type="email" class="form-control" id="exampleFormControlInput1"
                        placeholder="Masukkan hari khusus">
                </div>
                <br>
                <div class="mb-2">
                    <div class="row">
                        ...
                        <div class="card my-5 col-lg-4">
                            <div class="card-body text-center">
                                <img src="" width="" alt="" class=""><svg width="102"
                                    height="137" viewBox="0 0 102 137" fill="none"
                        ...
                        <div class="col-lg-7 my-auto mx-1">
                            <div class="row"
                                style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 15px; border: 0.50px black solid">
                                <button type="button" onclick="klik()" class="col-3"
                                    style="background: #F7941E; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 15px; border: 0px;">
                                    <div
                                        style="color: #EAEAEA; font-size: 15px; font-family: Poppins; font-weight: 600; word-wrap: break-word">
                                        Pilih File</div>
                                    <input class="form-control my-auto mx-1" style="display: none;" type="file"
                                        id="formFile">
                                </button>
                                <div class="col-9" id="infos"
                                    style="color: black; font-size: 15px; font-family: Poppins; font-weight: 600; word-wrap: break-word">
                                    Tidak ada file terpilih</div>
                            </div>
                        </div>
                    </div>
                    <div class="mt-2">
                        <textarea class="form-control" placeholder="Masukkan langkah langkah" id="floatingTextarea"></textarea>
                    </div>
                    <br>
                    <button class="btn btn-warning text-white"
                        style="float: right;background: #F7941E;">Tambahkan</button>
                </div> <br> <br>
                <button class="btn btn-warning text-white mb-4" style="float: right;background: #F7941E;">Tambah
                    Resep</button>
            </div>
        </div>
    </div>
    <script>
        ...
        function klik0() {
            document.getElementById('formFile0').click();
            document.getElementById('formFile0').addEventListener('change', function() {
                document.getElementById('infos0').innerHTML = "file sudah terpilih.";
