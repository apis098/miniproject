...
@section('content')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="mt-2">
                        <label for="exampleFormControlInput1" class="form-label"><b>Bahan-bahan 1</b></label>
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" name="pengeluaran_memasak" class="form-control" id="exampleFormControlInput1"
                    ...
                    <div class="mb-4">
                        <div class="row">
                            <label for="formFile" class="form-label"><b>Langkah-langkah 1</b></label>
                 ...
                 <br> <br>
                    <button type="submit" class="btn btn-warning text-white mb-4" style="float: right;background: #F7941E;">Tambah
                        Resep</button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        addInput2.addEventListener('click', function() {
            ...
            input2.innerHTML = `
                        <div class="row">
                            <label for="formFile" class="form-label"><b>Langkah-langkah ${num2}</b></label>
                            <div class="card my-5 col-lg-4">
                                <div class="card-body text-center">
                                    <img src="" width="" alt="" class=""><svg
                                        width="102" height="137" viewBox="0 0 102 137" fill="none"
        ...
        addInput1.addEventListener('click', function() {
            ...
            input1.innerHTML = `
                <label for="exampleFormControlInput1" class="form-label"><b>Bahan-bahan ${num}</b></label>
                <input type="text" name="bahan_resep[]" class="form-control" id="exampleFormControlInput1"
                    placeholder="Masukkan bahan makanan">
                <br>
                <label for="exampleFormControlInput1" class="form-label"><b>Takaran ${num}</b></label>
                <input type="text" name="takaran_resep[]" class="form-control" id="exampleFormControlInput1"
                    placeholder="Masukkan takaran">
                <br>
            `;
