    ...
    <div class="d-flex justify-content-center my-5">
        <div class="card" style="width: 28rem;">
            <div class="card-body mx-3">
                ...
                @endif
                <h5>Verifikasi E-Mail</h5>
                <p style="font-size: 14px;">
                    E-Mail verifikasi akan dikirim ke mailbox. <br>
                    Tolong cek E-Mail anda dan masukkan token yang diberikan.
                </p>
                <form action="{{ route('token.register') }}" method="post">
                    @csrf
                    <input type="email" name="email" value="{{ $email }}" hidden>
                    <div class="mb-3">
                        <input style="border-radius: 15px;" type="text" name="token" id="token"
                            placeholder="Token" class="form-control">
                    </div>
