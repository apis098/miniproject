                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        <ul class="navbar-nav mt-2 me-2 justify-content-center " style="margin-left: -2%">
                                            ...
                                            <li class="nav-item {{ request()->is('kursus') ? 'active' : '' }}"
                                                style="font-size: 15px">
                                                <a class="nav-link" id="navbar" href="{{ route('kursus') }}"><b> Kursus
                                                    </b></a>
                                            </li>
                                    ...
                                    <a class="nav-link" href="{{route('login')}}">Login</a>
                                        ...
                                        @if (Auth::check() && $notification != null)
                                            ...
                                            <form action="{{route('all.notifications')}}" id="notification-form" method="POST">
                                                @csrf
                                                @method('PATCH')
                                                <button type="button" id="notification-button"  data-toggle="modal" data-target="#exampleModalScrollable" class="text-light ms-1 me-3 yuhu" >
                                            ...
                                            <div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-scrollable" role="document" style="margin-left: 55%; margin-top:5%; max-width:420px; max-height:450px;">
                                                  <div class="modal-content" style="border-radius: 20px;">
                                                    <div class="modal-header">
                                                      <h5 class="modal-title text-orange fw-bolder" id="exampleModalScrollableTitle">Notifikasi</h5>
                                            ...
                                            @if ($unreadNotificationCount > 0)
                                                <span id="badge" class="badge badge-danger rounded-pill mb-4 me-2"
