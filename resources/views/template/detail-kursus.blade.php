                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle" style=" font-size: 20px; font-family: Poppins; font-weight: 700; letter-spacing: 0.70px; word-wrap: break-word">Laporkan pengguna</h5>
                        ...
                        <div class="modal-body d-flex align-items-center"> <!-- Tambahkan kelas "align-items-center" -->
                            <img src="{{ asset('images/default.jpg') }}" width="20%" height="20%" style="border-radius: 50%"
                                alt="">
                ...
                <div class="card-body">
                    <div class="row"
                          <div class="d-flex">
                            ...
                            <p class="text center my-1 mx-3" ><b>maz tatang</b></p>
