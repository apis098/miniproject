                ...
                @foreach($complaints as $row)
                    <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                        <div class="card text-dark card-has-bg click-col"
                            ...
                            <img class="card-img d-none" src="https://source.unsplash.com/UC0HZdUitWY/?food"
                        ...
                        <div class="card text-dark card-has-bg click-col"
                            ...
                            <div class="card-img-overlay d-flex flex-column">
                                <div class="card-body">
                                    <small class="card-meta mb-2">Makanan</small>
                                    <h4 class="card-title mt-0 "><a class="text-dark"
                                            href="https://creativemanner.com">Saya menciptakan suatu resep makanan</a>
                                    </h4>
                                    <small><i class="far fa-clock"></i> October 15, 2020</small>
                                </div>
                                <div class="card-footer">
