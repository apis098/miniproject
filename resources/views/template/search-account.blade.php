    ...
    <div class="container mt-5">
        <div class="row text-center">
            ...
            <div class="col-xl-3 col-sm-6 mb-5" >
                <div class="bg-white shadow-sm py-5 px-4 border border-secondary" style="border-radius: 20px; height:22rem;"><img
                    ...
                    <h5 class="mb-0">{{$row->name}}</h5> <span class="small text-muted">{{$row->email}}</span>
                        <div class="d-flex justify-content-start mt-3">
                            ...
                            <h5 class="mt-2 ms-3">{{$row->resep->count()}} Resep</h5>
                        </div>
                        <div class="d-flex justify-content-start mt-2 ms-2">
                            ...
                            <h5 class="mt-2 ms-3">700 Suka</h5>
                        </div>
                </div>
            </div><!-- End -->
                @endif
