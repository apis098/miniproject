            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box iconbox-orange">
                <div class="icon">
                    ...
                    <i class="fa-legular fa-file-lines"></i>
                  </div>
                <h4>Resep Premium</h4>
    ...
    <section class="section pricing">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h3>Pilih <span class="alternate">premium anda</span></h3>
                        <p>belajar memasak ataupun ingin mempelajari resep lebih dalam hanya dengan membeli premium</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="pricing-item animated-card">
                        ...
                        <div class="pricing-body animated-card">
                            ...
                            <ul class="feature-list m-0 p-0">
                                ...
                                <li>
                                    <p><span class="fa fa-check-circle available"></span>Akses premium 1 bulan penuh </p>
                                </li>
                                <li>
                    ...
                    <div class="pricing-item animated-card">
                        ...
                        <div class="pricing-body">
                            ...
                            <ul class="feature-list m-0 p-0">
                                ...
                                <li>
                                    <p><span class="fa fa-check-circle available"></span>Akses premium 3 bulan penuh </p>
                                </li>
                                <li>
                                    <p><span class="fa fa-check-circle available"></span>Easy Access</p>
                                </li>
                    ...
                    <div class="pricing-item animated-card">
                        ...
                        <div class="pricing-body">
                            ...
                            <ul class="feature-list m-0 p-0">
                                ...
                                <li>
                                    <p><span class="fa fa-check-circle available"></span>Akses premium 1 tahun penuh </p>
                                </li>
                                <li>
                                    <p><span class="fa fa-check-circle available"></span>Easy Access</p>
                                </li>
