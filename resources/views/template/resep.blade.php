                ...
                <div class="d-flex" style="min-width:400px;">
                  @foreach ($special_day as $nums => $d)
                    <div class="mr-4 mb-3" style="width:100%;">
                      ...
                      <button id="pilih_hari{{ $nums }}" onclick="pilih_hari({{ $nums }})"
                  ...
                  @foreach ($categories_foods_all as $num => $f)
                    <div class="mr-4 mb-3" style="width: 100%;">
                      ...
                      <button id="pilih_jenis_makanan{{ $num }}"
                        onclick="pilih_jenis_makanan({{ $num }})" class="btn btn-light" type="button"
                        class="p-2"
                  ...
                  <div class="col-12 mb-3">
                    ...
                    <h5>
                      <a style="color: black; font-weight: bold; font-size: 25px; margin-left:-1px"
                        class="judul-resep" href="/artikel/{{ $item->id }}/{{ $item->nama_resep }}">
                        {{ $item->nama_resep }}</a>
                    </h5>
                  ...
                  <div class="col-12 row d-flex justify-content-between">
                    ...
                    <div class="col-6 pr-0">
                      <span class="text-nowrap d-flex gap-2 align-items-center" style="font-size: 15px">
                        <img width="17px" height="17px" src="{{ asset('images/🦆 icon _time_.svg') }}"
                          alt="">
                    ...
                    <div class="col-6 my-3 d-flex gap-2 align-items-center pr-0">
                      <span class="text-nowrap">
                        <img width="16px" height="16px"
                          src="{{ asset('images/🦆 icon _comment square chat message_.svg') }}" alt="">
                    ...
                    <div class="col-6 my-3 pr-0">
                      ...
                      <span class="text-nowrap  d-flex gap-2 align-items-center">
                        <img width="17px" height="17px" src="{{ asset('images/🦆 icon _bookmark save_.svg') }}"
                          alt="">
                        {{ $item->favorite_count }}
