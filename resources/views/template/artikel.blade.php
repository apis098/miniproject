            ...
            <div class="card p-3">
                ...
                <div class="action d-flex mt-2 align-items-center">
                    ...
                    <div class="icons align-items-center input-group">
                        ...
                        @else
                            <form>
                                <button onclick="harusLogin()" type="button"
                                    class="yuhu me-2 text-dark btn-sm rounded-5" id="like-button-comment">
                                    <i class="fa-regular fa-thumbs-up"></i>
                                </button>
                            </form>
                        @endif
                        @if (Auth::check())
                            ...
                            @else
                                @if (Auth::user()->id === $idAdmin->id)
                                    ...
                                    <div class="modal fade" id="blockModal{{ $row->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-body d-flex align-items-center col-12">
                                                        ...
                                                        <div class="col-4">
                                                            <img style="margin-left: -50%;" class="rounded-circle mb-1"
                                                                src="{{ asset('images/alasan.png') }}" width="250px"
                                                                height="180px">
                                                        </div>
                                                        <div class="col-md-8">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="" method="POST">
                                                    ...
                                                    <div class="modal-body d-flex align-items-center">
                                                        ...
                                                        @if ($row->foto)
                                                            <img class="me-2"
                                                                src="{{ asset('storage/' . $row->foto) }}" width="106px"
                            ...
                            <div class="action d-flex mt-2 align-items-center">
                                ...
                                <div class="icons align-items-center input-group">
                                    ...
                                    @else
                                        <form>
                                            <button type="button" onclick="harusLogin()"
                                                class="yuhu me-2 text-dark btn-sm rounded-5"
                                                id="like-reply-comment-button">
                                                <i class="fa-regular fa-thumbs-up"></i>
                                            </button>
                                        </form>
                                    ...
                                    @if (Auth::check())
                                        ...
                                        @if (Auth::user()->id == $item->user->id)
                                            <form action="{{ route('delete.reply.comment', $item->id) }}" method="POST"
                                        ...
                                        @else
                                            @if (Auth::user()->id === $idAdmin->id)
                                                ...
                                                <div class="modal fade" id="blockModalReply{{ $item->id }}"
