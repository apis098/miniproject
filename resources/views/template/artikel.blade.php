              ...
              <button type="submit" style="position: absolute;  background-color:#F7941E; "
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24">
                  <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                    stroke-width="2" d="M5 5a5 5 0 0 1 7 0a5 5 0 0 0 7 0v9a5 5 0 0 1-7 0a5 5 0 0 0-7 0V5zm0 16v-7" />
                </svg>
              </button>
            @endif
          @else
                ...
                <div class="modal-content" style="border-radius: 15px;">
                  ...
                  <div class="modal-body">
                    <div class="d-flex align-items-center ms-3">
                      <img src="{{ asset('images/income.png') }}" width="180px" height="180px" style="border-radius: 50%"
                        alt="">
                    ...
                    <div class="row">
                      <div class="d-flex justify-content-end">
                        <a href="/koki/income-koki" class="btn btn-light mb-3 me-1 text-light"
                          style="border-radius: 15px; background-color:#F7941E;"><b class="ms-2 me-2">Detail</b></a>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  @else
                    <form action="{{ route('Resep.like', $show_resep->id) }}" method="POST" class="like-form">
                      ...
                      @if (
                        ...
                        <button type="submit" class="btn btn-light btn-sm text-light rounded-circle p-2 mr-3 like-button"
                          style="border-color: #F7941E;">
                          <svg style="color: #F7941E" xmlns="http://www.w3.org/2000/svg" width="21" height="21"
                            viewBox="0 0 256 256">
                            <path fill="currentColor"
                      ...
                      @else
                        <button type="submit"
                          ...
                          <svg style="color: #ffffff" xmlns="http://www.w3.org/2000/svg" width="21" height="21"
                            viewBox="0 0 256 256">
                            <path fill="currentColor"
                              d="M234 80.12A24 24 0 0 0 216 72h-56V56a40 40 0 0 0-40-40a8 8 0 0 0-7.16 4.42L75.06 96H32a16 16 0 0 0-16 16v88a16 16 0 0 0 16 16h172a24 24 0 0 0 23.82-21l12-96A24 24 0 0 0 234 80.12ZM32 112h40v88H32Zm191.94-15l-12 96a8 8 0 0 1-7.94 7H88v-94.11l36.71-73.43A24 24 0 0 1 144 56v24a8 8 0 0 0 8 8h64a8 8 0 0 1 7.94 9Z" />
                          </svg>
                    ...
                    <form action="{{ route('favorite.store', $show_resep->id) }}" method="POST"class="favorite-form">
                      ...
                      @if (
                        ...
                        <button type="submit"
                          ...
                          style="border-color: #F7941E;">
                          <svg style="color: #F7941E;" xmlns="http://www.w3.org/2000/svg" width="22"
                      ...
                      @else
                        <button type="submit"
                          class="btn btn-light btn-sm text-light rounded-circle p-2 mr-3 favorite-button"
                          style="background-color: #F7941E;">
                          <svg style="color: #ffffff" xmlns="http://www.w3.org/2000/svg" width="22" height="21"
                            viewBox="0 0 24 24">
                            <path fill="currentColor"
                              d="M5 21V5q0-.825.588-1.413T7 3h10q.825 0 1.413.588T19 5v16l-7-3l-7 3Zm2-3.05l5-2.15l5 2.15V5H7v12.95ZM7 5h10H7Z" />
                          </svg>
                    ...
                    <form action="#">
                      @if ($gift_check > 0)
                        <button type="button" id="gift_icon_btn{{ $show_resep->id }}" data-toggle="modal"
                          data-target="#gift" class="btn btn-light btn-sm text-light rounded-circle p-2 mr-3"
                          style="background-color: #F7941E;"><svg id="gift_icon{{ $show_resep->id }}"
                            style="color:#ffffff;" xmlns="http://www.w3.org/2000/svg" width="22" height="21"
                            viewBox="0 0 24 24">
                            <g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2">
                              <path stroke-linecap="round" d="M4 11v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8" />
                              <path
                      ...
                      @else
                        <button type="button" id="gift_icon_btn{{ $show_resep->id }}" data-toggle="modal"
                          ...
                          style="border-color: #F7941E;"><svg id="gift_icon{{ $show_resep->id }}"
                            style="color:#F7941E;" xmlns="http://www.w3.org/2000/svg" width="22" height="21"
                            viewBox="0 0 24 24">
                            <g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2">
                              <path stroke-linecap="round" d="M4 11v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8" />
                              <path
                    ...
                    <form action="#">
                      @if ($share_check > 0)
                        <button type="button" data-toggle="modal" data-target="#shareModal{{ $show_resep->id }}"
                          ...
                          style="background-color: #F7941E;"><svg id="share_icon" style="color: #ffffff;"
                            xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 24 24">
                            <path fill="currentColor"
                      ...
                      @else
                        <button type="button" data-toggle="modal" data-target="#shareModal{{ $show_resep->id }}"
                          class="btn btn-light btn-sm text-light rounded-circle p-2 mr-3" id="share_button_icon"
                          style="border-color: #F7941E;"><svg id="share_icon" style="color: #F7941E;"
                            xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 24 24">
                            <path fill="currentColor"
                              d="M20.56 3.34a1 1 0 0 0-1-.08l-17 8a1 1 0 0 0-.57.92a1 1 0 0 0 .6.9L8 15.45v6.72L13.84 18l4.76 2.08a.93.93 0 0 0 .4.09a1 1 0 0 0 .52-.15a1 1 0 0 0 .48-.79l1-15a1 1 0 0 0-.44-.89ZM18.1 17.68l-5.27-2.31L16 9.17l-7.65 4.25l-2.93-1.29l13.47-6.34Z" />
                          </svg>
                    ...
                    <div class="modal" id="shareModal{{ $show_resep->id }}">
                      <form id="share_form{{ $show_resep->id }}"
                        action="{{ route('share.recipe', ['recipe_id' => $show_resep->id]) }}" method="POST">
                        @csrf
                          ...
                          <div class="modal-content">
                                ...
                                <div class="search" style="border-radius: 15px;">
                                  <div class="col-lg-11 mt-2">
                                    <div class="search-2"> <i class='bx bxs-map'></i>
                                      ...
                                      <input id="search" type="text" name="" style="text-align: left;"
                                        placeholder="Cari...">
                                  ...
                                  <div class="d-flex mt-4">
                                    ...
                                    <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1 mt-3">
                                      <input type="checkbox" class="select-checkbox" name="user_id[]"
                                        ...
                                        value="{{ $user->id }}">
                                      <label for="checkbox-{{ $show_resep->id }}-{{ $user->id }}"></label>
                                    </div>
                                  </div>
                                </div>
                              @endforeach
                            ...
                            <div class="modal-footer d-flex justify-content-center">
                              <button onclick="shareButton({{ $show_resep->id }})" id="shr-btn{{ $show_resep->id }}"
                                class="btn btn-light fw-bolder text-light col-lg-11" type="submit"
                            ...
                            <div class="modal-body">
                              <div class="d-flex ">
                                <label for="inputKecil" class="col-lg-3 my-1">
                                  <div class="card border-2 scale" id="smallGift" data-card-selected="false"
                                ...
                                <label for="mediumInput" class="col-lg-3 my-1">
                                  <div class="card border-2 scale" id="mediumGift" data-card-selected="false"
                                    style="width: 150px; height: 225px; border-radius: 15px; border: black solid; overflow: hidden;">
                                ...
                                <label for="extraInput" class="col-lg-3 my-1">
                                  <div class="card border-2 scale" id="extraGift" data-card-selected="false"
                                    style="width: 150px; height: 225px; border-radius: 15px; border: black solid; overflow: hidden;">
                              ...
                              <div class="d-flex mt-4 ml-3">
                                <input type="number" id="moreInput" name="moreInput" width="500px"
                                ...
                                <input type="text" id="message" name="message" width="500px"
                                ...
                                <button type="submit" onclick="giftButton({{ $show_resep->id }})"
                    ...
                    <div class="modal fade" id="reportModal" tabindex="-1" role="dialog"
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <form id="FormReportResep" action="{{ route('report.resep', $show_resep->id) }}"
                            method="POST">
                            @csrf
                            <div class="modal-body d-flex align-items-center">
                              <!-- Tambahkan kelas "align-items-center" -->
                              @if ($show_resep->foto_resep)
                                <img class="me-2" src="{{ asset('storage/' . $show_resep->foto_resep) }}"
                            ...
                            <div class="modal-footer">
                              <button type="submit" class="btn btn-light text-light" onclick="ButtonReportResep()"
              ...
              <div class="col-12 card-body d-flex flex-row">
                <div class=" d-flex flex-column knan" style="position: relative;">
                  <img src="{{ asset('storage/' . $item_langkah->foto_langkah) }}" class="mt-3 besar"
                    alt="{{ $item_langkah->foto_langkah }}" style="border-radius: 10px; border: 1px solid black;">
                  <button type="button"
            ...
            @if (Auth::check())
              <form method="POST" id="FormTambahKomentarResep{{ Auth::user()->id }}"
                ...
                <div class="input-group ">
                  <input type="text" id="comment_recipe{{ Auth::user()->id }}" name="komentar" maxlength="255"
                    {{ $userLog === 1 ? 'disabled' : '' }} class="form-control rounded-3 kri bsar"
        ...
        <div class="card p-3">
              ...
              @if (Auth::check() && Auth::user()->role == 'admin')
                <span>
                  <div class="font-weight-semibold ms-1 me-2">
                    ...
                    <svg class="text-primary ms-1" xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                      viewBox="0 0 24 24">
                      <path fill="currentColor"
          ...
          <div class="action d-flex mt-2 align-items-center">
            ...
            <div class="icons align-items-center input-group">
              <form action="{{ route('like.comment.recipe', $row->id) }}" method="POST" id="like-form-comment">
                @csrf
                @if (
                    $userLogin &&
                        $row->like()->where('users_id', auth()->user()->id)->exists())
                  <button type="submit" class="yuhu me-2 text-orange btn-sm rounded-5" id="like-button-comment">
                    <i class="fa-solid fa-thumbs-up"></i>
                  </button>
                @else
                  <button type="submit" class="yuhu me-2 text-dark btn-sm rounded-5" id="like-button-comment">
                    ...
                    <div class="modal-content">
                      ...
                      <form action="{{ route('Report.comment.recipes', $row->id) }}" method="POST">
                        ...
                        <div class="modal-body d-flex align-items-center">
                          <!-- Tambahkan kelas "align-items-center" -->
                          @if ($row->foto)
                            <img class="me-2" src="{{ asset('storage/' . $row->foto) }}" width="106px"
                              height="104px" style="border-radius: 50%" alt="">
                            <textarea class="form-control" style="border-radius: 15px" name="description" rows="5" placeholder="Alasan"></textarea>
                          @else
                            <img class="me-2" src="{{ asset('images/default.jpg') }}" width="106px" height="104px"
              ...
              @elseif(Auth::check() && auth()->user()->role == 'admin')
                <button type="button" data-toggle="modal" data-target="#blockModal{{ $row->id }}"
                  class="yuhu text-danger btn-sm rounded-5 "><svg xmlns="http://www.w3.org/2000/svg" width="20"
              ...
              @if (Auth::check())
                <form action="{{ route('balasan.komentar.resep', [$row->id, $row->user_penerima->id]) }}"
                  ...
                  <div class="input-group mb-3">
                    <input type="text" id="reply_comment{{ $row->id }}" name="reply_comment" width=""
              ...
              @foreach ($row->reply_comment_recipe as $item)
                <div id="CardBalasanKomentarResep{{ $item->id }}">
                  ...
                  <div class="action d-flex mt-2 align-items-center">
                    ...
                    <div class="icons align-items-center input-group">
                      ...
                      @if (Auth::check() && $userLogin->id != $item->users_id && $userLogin->role != 'admin')
                        <button type="button" data-toggle="modal" data-target="#modalRpl{{ $item->id }}"
                          class="yuhu text-danger btn-sm rounded-5 "><i
                            class="fa-solid fa-triangle-exclamation me-2"></i>
                        </button>
                        {{-- modal --}}
                        <div class="modal fade" id="modalRpl{{ $item->id }}" tabindex="-1" role="dialog"
                          aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <form action="{{ route('Report.reply.comment.recipes', $item->id) }}" method="POST">
                                ...
                                <div class="modal-body d-flex align-items-center">
                                  <!-- Tambahkan kelas "align-items-center" -->
                                  @if ($item->user->foto)
                                    <img class="me-2" src="{{ asset('storage/' . $item->user->foto) }}"
                                      width="106px" height="104px" style="border-radius: 50%" alt="">
                                    <textarea class="form-control" style="border-radius: 15px" name="description" rows="5" placeholder="Alasan"></textarea>
                                  @else
                                    <img class="me-2" src="{{ asset('images/default.jpg') }}" width="106px"
                      ...
                      @elseif(Auth::check() && auth()->user()->id == $item->users_id)
                        <form method="POST" action="{{ route('delete.reply.comment', $item->id) }}"
                          ...
                          @csrf
                          @method('DELETE')
                          <button type="submit" id="buttonreplycomment{{ $item->id }}"
                            onclick="ClickDeleteReplyComment({{ $item->id }})" hidden></button>
                  ...
                  <div class="collapse" id="collapses{{ $item->id }}">
                    <br>
                    @if (Auth::check())
                      <form action="{{ route('balasan.balasan.komentar.resep', [$row->id, $item->user->id]) }}"
