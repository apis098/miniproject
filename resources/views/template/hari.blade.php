                                    ...
                                    <div class="col-md-12">
                                        <div>
                                            <div class="search-2"> <i class='bx bxs-map'></i>
                                                <form action="{{ url('/hari') }}" method="get">
                                                    <select name="hari[]" class="search-bahan" id="search-bahan" multiple="multiple">
                                                        @foreach ($haries as $i)
                ...
                <div class="col-lg-4 mb-3 col-sm-12 col-md-6">
                    <div class="card" style="border-radius: 15px; border: 0.50px black solid">
                        <div class="card-header my-3 mx-auto" style="background-color: white;">
                            <img width="250px" height="230px" style="border-radius: 9999px; border: 0.50px black solid"
