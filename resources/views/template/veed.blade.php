      ...
      <div style="width: 100%; display: flex; flex-wrap: wrap;">
                ...
                <div class="d-flex mb-3">
                  @if ($row->foto)
                    <a href="/profile-orang-lain/{{ $row->id }}">
                      <img src="{{ asset('storage/' . $row->foto) }}" class="border rounded-circle me-2" alt="Avatar"
                        style="height: 40px" />
                    </a>
                  @else
                    <a href="/profile-orang-lain/{{ $row->id }}">
        ...
        <style>
          ...
          @media (max-width: 767px) {
            .d-flex {
              display: block;
              /* Ganti dengan properti display yang sesuai */
            }
          }
                ...
                <form action="{{ route('upload.video') }}" method="post" enctype="multipart/form-data"
                  ...
                  @if (Auth::user()->isSuperUser === 'yes')
                    <div class="d-flex mb-2">
                      ...
                      <input type="radio" class="btn-check" name="isPremium" id="success-outlined" autocomplete="off"
                        value="no">
                      <label class="btn btn-select mr-3" id="free" for="success-outlined">Gratis</label>

                      <input type="radio" class="btn-check" name="isPremium" id="danger-outlined" autocomplete="off"
                        value="yes">
                  ...
                  <textarea name="deskripsi_video" class="form-control" placeholder="Ketik apa yang anda pikirkan" id="deskripsi_video"
                    maxlength="225" rows="5" required>{{ old('deskripsi_video') }}</textarea>
                  <br>
            ...
            <div class="card mt-4 mb-5 item-video" id="itemvideo{{ $item_video->id }}">
              ...
              <div class="bg-image hover-overlay ripple rounded-0" data-mdb-ripple-color="light">
                @if ($item_video->authenticatePrem() === 200)
                  ...
                  <video class="video-js vjs-theme-city" id="my-video" controls preload="auto" width="615"
                    height="315" data-setup="{}">
                ...
                @elseif ($item_video->authenticatePrem() === 0)
                  ...
                  <video class="video-js vjs-theme-city feed" id="my-video" controls preload="auto" width="615"
                    height="315" data-setup="{}">
                    <source src="{{ asset('storage/' . $item_video->upload_video) }}" type="video/mp4" />
                    <p class="vjs-no-js">
                      To view this video please enable JavaScript, and consider upgrading to a
                ...
                <div class="d-flex justify-content-between mb-2">
                  <div class="col-9 pl-0">
                    <span class="d-flex flex-row" style="color: black;">
                      ...
                      @if (Auth::check())
                        ...
                        @if ($item_video->checkLikeFeed(Auth::user()->id))
                          <form id="formLikeVeed{{ $urut }}"
                            ...
                            <button class="pr-0 pl-0" style="border: none; background-color:white; margin-bottom: 1px;"
                              onclick="likeFeed({{ $urut }})">
                              <i class="text-orange fa-solid fa-lg fa-thumbs-up" id="likeB{{ $urut }}"
                        ...
                        @else
                          <form id="formLikeVeed{{ $urut }}"
                            ...
                            <button class="text-dark pr-0 pl-0"
                              ...
                              onclick="likeFeed({{ $urut }})">
                              <i id="likeB{{ $urut }}" class="fa-regular fa-lg fa-thumbs-up"
                                style="font-size: large;"></i>
                            </button>
                            <span style="vertical-align: middle; font-size: xxx-small;" class="my-auto ml-auto"
                              id="countLikeFeed{{ $urut }}">{{ $item_video->like_veed->count() }}</span>
                      ...
                      <button type="button" class=" ml-2 mr-2 yuhu text-dark" {{-- onclick="openModel({{ $urut }})" --}}
                        {{-- id="button-modal-komentar-feed{{ $urut }}" --}} data-toggle="collapse" role="button" aria-expanded="false"
                        aria-controls="collapseExample" data-target="#commentCollapse{{ $urut }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="20" viewBox="0 0 16 16"
                                ...
                                <form id="formCommentVeed{{ $urut }}"
                                  ...
                                  <div class="row mb-3">
                                    <div class="col-lg-1 col-md-1 col-2 pl-0">
                                      ...
                                      @else
                                        <img src="{{ asset('images/default.jpg') }}" class="border rounded-circle me-5"
                                          alt="Avatar" style="height: 60px; margin-left: 20px;" />
                                      @endif
                                    </div>
                                    <div class="col-lg-9 col-md-9 col-10">
                                      <input type="text" id="input_comment_feed{{ $urut }}"
                                        name="commentVeed" width="100%" class="form-control rounded-3 me-3"
                                        style="margin-top: 12px" placeholder="Masukkan komentar...">
                                    </div>
                              ...
                              @else
                                <form>
                                  <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-10">
                                      <input type="text" id="comment-veed1" name="commentVeed" width="100%"
                                        class="form-control rounded-3 me-3" style="margin-top: 12px"
                      ...
                      <a class="ml-1 mr-1 my-auto text-dark text-center" href="#" data-bs-toggle="modal"
                        ...
                        <span id="shared_count{{ $item_video->id }}"
                          style="vertical-align: middle; font-size: xxx-small;"
                      ...
                      <div class="modal" id="bagikan{{ $item_video->id }}">
                        <form id="share_form{{ $item_video->id }}" action="{{ route('share.feed', $item_video->id) }}"
                          method="POST">
                          @csrf
                          <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                  ...
                                  <div class="search col-lg-9 col-10 col-md-7 pl-md-2" style="border-radius: 15px;">
                                    <div class=" mt-2">
                                      <div class="search-2"> <i class='bx bxs-map'></i>
                                        ...
                                        <input id="search" type="text" class="ml-4 ml-md-0" name=""
                                ...
                                @foreach ($allUser as $user)
                                  <div class="element-pencarian">
                                    <div class="d-flex mt-4">
                                      <div class="col-xl-1 col-lg-1 col-md-2 col-sm-2 pl-0 col-2">
                                        <a class="foto" href="">
                                          @if ($user->foto)
                                            <img src="{{ asset('storage/' . $user->foto) }}"
                                              class="border rounded-circle me-2" alt="Avatar" style="height: 55px" />
                                          @else
                                      ...
                                      <div class="col-xl-10 col-lg-10 col-md-9 col-sm-9 col-9">
                                        <div class="nama rounded-3 pr-3 py-1">
                                          <a href="" class="text-dark mb-0">
                                            <strong class="input-name">{{ $user->name }}</strong>
                                          </a>
                                      ...
                                      <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1 mt-3 p-0">
                                        <input type="checkbox" class="select-checkbox" name="user_id[]"
                                          id="checkbox-{{ $item_video->id }}-{{ $user->id }}"
                                          value="{{ $user->id }}">
                                        <label for="checkbox-{{ $item_video->id }}-{{ $user->id }}"></label>
                                      </div>
                                    </div>
                                  </div>
                                @endforeach
                              ...
                              <div class="modal-footer d-flex justify-content-center">
                                <button class="btn btn-light fw-bolder text-light col-lg-11" type="submit"
                                  onclick="shareButton({{ $item_video->id }})" id="shr-btn{{ $item_video->id }}"
                  ...
                  <div class="col-3 pr-0">
                    ...
                    <span class="d-flex" style="float: right;">
                                ...
                                <div class="row">
                                  <label for="inputKecil{{ $item_video->id }}"
                                    ...
                                    <div class="card border-2 border-black scale"
                                      ...
                                      id="smallGift{{ $item_video->id }}" style="width: auto; height: auto;"
                                      data-card-selected="false">
                                      <img src="{{ asset('img/kecil.png') }}" class="card-img-top" alt="">
                                      <div class="card-body">
                                        <input hidden type="radio" value="5000" name="giftInput"
                                  ...
                                  <label for="mediumInput{{ $item_video->id }}"
                                    ...
                                    <div class="card border-2 scale border-black"
                                      ...
                                      id="mediumGift{{ $item_video->id }}" style="width: auto; height: auto;"
                                      data-card-selected="false">
                                      <img src="{{ asset('img/sedang.png') }}" class="card-img-top" alt="">
                                      <div class="card-body">
                                        <input hidden type="radio" value="10000" name="giftInput"
                                  ...
                                  <label for="extraInput{{ $item_video->id }}"
                                    ...
                                    <div class="card border-2 scale border-black"
                                      ...
                                      id="extraGift{{ $item_video->id }}" style="width: auto; height: auto;"
                                      data-card-selected="false">
                                      <img src="{{ asset('img/besar.png') }}" class="card-img-top" alt="">
                                      <div class="card-body">
                                        <input hidden type="radio" value="20000" name="giftInput"
                                  ...
                                  <label for="moreInput" class="col-lg-3 col-md-6 col-12 my-1 ">
                                    <button type="button" class="card border-2 scale border-black"
                                      onclick="more_gift_click({{ $item_video->id }})"
                                      id="moreGift{{ $item_video->id }}" style="width: 100%; height: auto;"
                                      data-card-selected="false">
                                      <img src="{{ asset('img/lainnya.png') }}" class="card-img-top mb-3"
                                        alt="">
                                      <div class="card-body"
                                        ...
                                        <p id="displayNumber{{ $item_video->id }}" class="text-center mb-0"
                                          style="color: black; font-size: 15px; font-family: Poppins; font-weight: 400; word-wrap: break-word">
                                          Masukkan Nilai</p>
                                      </div>
                                    </button>
                                ...
                                <div class="col-12">
                                  <div class="row mt-4">
                                    ...
                                    <div class="col-lg-2 col-md-12 col-12 pr-0 pl-0 penempatan-button">
                                      <button type="submit" onclick="gift_submit_button({{ $item_video->id }})"
                                ...
                                <div class="modal-content">
                                  ...
                                  <form action="{{ route('report.feed', $item_video->id) }}" method="POST"
                                    ...
                                    <div class="modal-body d-flex align-items-center">
                                      @if ($item_video->user->foto)
                                        <img class="me-2" src="{{ asset('storage/' . $item_video->user->foto) }}"
                                          width="106px" height="104px" style="border-radius: 50%" alt="">
                                      @else
                      ...
                      <form action="{{ route('favorite.feed.store', $item_video->id) }}" method="POST"
                        id="favorite-form{{ $item_video->id }}" class="favorite-form{{ $item_video->id }}">
                        @csrf
                        @if (Auth::check() &&
                    ...
                    <div class="modal-content">
                      <form action="" method="POST">
                        ...
                        <div class="modal-body d-flex align-items-center col-12 mb-3">
                          <input type="number" id="comment-veed1" name="commentVeed" width="500px"
                            class="form-control rounded-3 me-3" style="margin-top: 12px; border-radius:100px;"
                ...
                <div class="d-flex mb-3">
                  <div class="container">
                    <div class="row">
                      ...
                      <p style="max-width: 100%;" class="p-0 text-deskripsi">{{ $item_video->deskripsi_video }}</p>
                      <!-- </div> -->
                      <div class="collapse p-0" style="margin-top: -2%;" id="commentCollapse{{ $urut }}">
                        <div class="col-12">
                          <!-- form komentar feed start -->
                          <div class="">
                            <div class="row">
                                ...
                                <form id="formCommentFeed{{ $item_video->id }}"
                                  ...
                                  <div class="row mb-3">
                                    ...
                                    <div class="col-xl-9 col-lg-8 col-md-9 col-7 pl-1">
                                      <input type="text" id="input_comment_veed{{ $item_video->id }}"
                                        name="commentVeed"
                                        style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); width: 100%; border-radius:30px;"
                                        class="form-control border border-dark border-5 inputan-komentar"
                                        placeholder="Masukkan komentar...">
                                    </div>
                                    <div class="col-xl-2 col-lg-3 col-md-2 col-3 p-0">
                                      <button type="submit" id="buttonCommentVeed{{ $urut }}"
                                  ...
                                  <div class="row mb-3">
                                    ...
                                    <div class="col-xl-9 col-lg-7 col-md-9 col-7 pl-1">
                                      <input type="text" id="input_comment_feed" name="commentVeed"
                                        style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); width: 100%; border-radius:30px;"
                                        class="form-control border border-dark border-5 me-3 inputan-komentar"
                                        placeholder="Masukkan komentar...">
                                    </div>
                              ...
                              <div id="komen_feed{{ $item_video->id }}" class="pl-0">
                                @foreach ($item_video->comment_veed->sortByDesc('created_at') as $nomer => $item_comment)
                                  <div class="media row mb-2" id="komen_veed_ini{{ $item_comment->id }}"
                                    style="">
                                    <div class="d-flex col-12">
                                      @if ($item_comment->user_pengirim->foto)
                                        <img class="rounded-circle foto-komentar"
                                      ...
                                      <div class="d-flex col-lg-12" style="margin-top:-3%;">
                                        ...
                                        <div class="d-flex icon-komentar1">
                                          ...
                                          @else
                                            <img src="{{ asset('images/🦆 icon _thumbs up_.svg') }}"
                                              onclick="harusLogin()" width="15px" height="40px" alt=""
                                              class="me-3 " style="margin-left: 40%;">
                                          @endif
                                        ...
                                        <div class="ms-2 mt-2 mr-auto">
                                          ...
                                          @if (Auth::user())
                                            @if (Auth::user()->role != 'admin' && Auth::user()->id !== $item_comment->user_pengirim->id)
                                              <a data-bs-toggle="modal" href="#ModalL{{ $item_comment->id }}"
                                                class="yuhu text-danger btn-sm rounded-5 "><i
                                                  class="fa-solid fa-triangle-exclamation"></i>
                                              </a>
                                              <div class="modal fade" data-bs-backdrop="static"
                                                id="ModalL{{ $item_comment->id }}" tabindex="-1" role="dialog"
                                                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                  <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form id="FormLaporkanKomentarUtama{{ $item_comment->id }}"
                                            ...
                                            @elseif(Auth::user()->id == $item_comment->user_pengirim->id)
                                              ...
                                              <form method="POST"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                  onclick="deletedCommentFeed({{ $item_comment->id }})" hidden
                                            ...
                                            @elseif(Auth::user()->role == 'admin')
                                              ...
                                              <div class="modal fade" data-bs-backdrop="static"
                                                id="blockMod{{ $item_comment->id }}" tabindex="-1" role="dialog"
                                                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                  <div class="modal-content">
                                                    <div class="modal-header">
                                          ...
                                          @else
                                            ...
                                            <button type="button" onclick="harusLogin()"
                                              class="yuhu text-danger btn-sm rounded-5 ms-3 valenzi"><i
                                        ...
                                        <div style="margin-right:-2%;" class="d-flex justify-content-end mt-2">
                                          @if ($item_comment->count_replies() > 0)
                                            <a href="#" class="text-secondary ml-2" data-toggle="collapse"
                                              data-target="#collapse{{ $item_comment->id }}" aria-expanded="true"
                                          ...
                                          @else
                                            <a href="#" class="text-secondary my-auto ml-2"
                                              data-toggle="collapse" data-target="#collapse{{ $item_comment->id }}"
                                              ...
                                              &nbsp; <small class="d-none d-sm-inline-block">Balas</small>
                                            </a>
                                          @endif
                                        </div>
                                      </div>
                                      <!-- Komentar Balasan Collapse Start -->
                                      <div class="collapse" style="margin-right: -7%;"
                                        ...
                                        <div class="card-body pr-5">
                                          <div class="container">
                                            <div class="row">
                                              @if (Auth::check())
                                                <form id="formReplyComment{{ $item_comment->id }}"
                                              ...
                                              @endif
                                              <div id="reply_comments{{ $item_comment->id }}" class="mt-4">
                                                ...
                                                @foreach ($item_comment->reply_comment_veed as $numeric => $reply_comment)
                                                      ...
                                                      <div class="d-flex ">
                                                        <div class="d-flex col-2 icon-komentar3 pl-0 mr-auto"
                                                          ...
                                                          <div class="ms-2 mt-2 mr-auto">
                                                                ...
                                                                <div class="modal fade" data-bs-backdrop="static"
                                                                  ...
                                                                  <div class="modal-dialog modal-dialog-centered"
                                                                    ...
                                                                    <div class="modal-content">
                                                                      ...
                                                                      <form action="{{route('block.reply1.comment.feed', $reply_comment->id)}}" id="FormBlokirKomen{{$reply_comment->id}}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <div class="modal-body col-12 row pr-0">
                                                                          <div
                                                            ...
                                                            @else
                                                              {{-- Untuk user belum login --}}
                                                              <button type="button" onclick="harusLogin()"
                                                                class="yuhu text-danger btn-sm rounded-5 tegar"><i
                                                                  class="fa-solid fa-triangle-exclamation me-2"></i>
                                                              </button>
                                                            @endif
                                                            {{-- --}}
                                                        ...
                                                        <div style="margin-right:-2%"
                                                          ...
                                                          <a href="#" class="text-secondary my-auto ml-2"
                                                            ...
                                                            &nbsp;
                                                            <small class="me-1 d-none d-sm-inline-block">Balas</small>
                                                          </a>
                                                        </div>
                                                      </div>
                                                  ...
                                                  <div class="collapse" id="collapse2{{ $reply_comment->id }}">
                                                  ...
                                                  @foreach ($reply_comment->balasRepliesCommentsFeeds as $nomers => $reply_replyComment)
                                                        ...
                                                        <div class="d-flex icon-komentar2" style="margin-top: -3%;">
                                                          <div class="d-flex col-2 ms-2 pl-0 mr-auto">
                                                            ...
                                                            <span
                                                              ...
                                                              class="mt-2" style="margin-left: -7%;">
                                                              {{ $countLike3sd }}
                                                            </span>
                                                            ...
                                                            <div class="ms-2 mt-2 mr-auto">
                                                              ...
                                                              @if (Auth::check())
                                                                @if (Auth::user()->role != 'admin' && Auth::user()->id !== $reply_replyComment->user_pengirim->id)
                                                                  <a data-bs-toggle="modal"
                                                                    data-target="#ModalLaporseee{{ $reply_replyComment->id }}"
                                                                    href="#ModalLaporseee{{ $reply_replyComment->id }}"
                                                                    class="yuhu text-danger btn-sm rounded-5 "><i
                                                                      class="fa-solid fa-triangle-exclamation"></i>
                                                                  </a>
                                                                  <div class="modal fade" data-bs-backdrop="static"
                                                                    id="ModalLaporseee{{ $reply_replyComment->id }}"
                                                                    tabindex="-1" role="dialog"
                                                                    aria-labelledby="exampleModalCenterTitle"
                                                                    aria-hidden="true">
                                                                    <div class="modal-dialog modal-dialog-centered"
                                                                      ...
                                                                      <div class="modal-content">
                                                                        <div class="modal-header">
                                                                          <h5 class="modal-title" id="reportModal"
                                                                            style=" font-size: 22px; font-family: Poppins; font-weight: 700; letter-spacing: 0.70px; word-wrap: break-word">
                                                                            Laporkan Balasan Balasan Komentar
                                                                            {{ $reply_replyComment->user_pengirim->name }}
                                                                          </h5>
                                                                          <button type="button" class="close"
                                                                            data-bs-dismiss="modal"
                                                              ...
                                                              @else
                                                                {{-- Untuk user belum login --}}
                                                                <button type="button" onclick="harusLogin()"
                                                                  class="yuhu text-danger btn-sm rounded-5 trisqi"><i
                                                                    class="fa-solid fa-triangle-exclamation me-2"></i>
                                                                </button>
                                                              @endif
                                                              {{-- --}}
                                                          ...
                                                          <div style="margin-right:-2%"
                                                            ...
                                                            <a href="#" class="text-secondary my-auto ml-2"
                                                              ...
                                                              &nbsp;
                                                              <small class="me-3 d-none d-sm-inline-block">Balas</small>
                                                            </a>
                                                          </div>
                                                        </div>
                                                      </div>
                                                    ...
                                                    <div class="collapse"
                                                      ...
                                                      <div id="replies_reply2{{ $reply_replyComment->id }}">
            ...
            <div class="card-body" style="height: 500px;">
              @foreach ($recipes as $resep)
                <div class="d-flex mb-3">
                  <a href="">
                    @if ($resep->user->foto)
                      <img src="{{ asset('storage/' . $resep->user->foto) }}" class="border rounded-circle me-2"
                        alt="Avatar" style="height: 40px" />
                    @else
              ...
              @foreach ($course as $kursus)
                <div class="d-flex mb-3">
                  <a href="/detail_kursus/{{ $kursus->id }}">
                    @if ($kursus->user->foto)
                      <img src="{{ asset('storage/' . $kursus->user->foto) }}" class="border rounded-circle me-2"
                        alt="Avatar" style="height: 40px" />
                    @else
                      <img src="{{ asset('images/default.jpg') }}" class="border rounded-circle me-2"
                        alt="Avatar" style="height: 40px" />
                                                                                                                            ...
                                                                                                                            {{-- --}}
                                                                                                                                    ...
                                                                                                                                    <form
                                                                                                                                        ...
                                                                                                                                        <button
                                                                                                                                            ...
                                                                                                                                            class="yuhu text-danger btn-sm rounded-5 float-end">
                                                                                                                                            <i
                                                                                                                                                class="fa-solid fa-trash" style="font-size: medium;"></i>
                                                                                                                                        </button>
                                                                                                                                    </form>
                                                                                                            ...
                                                                                                            <div class="d-flex">
                                                                                                                ...
                                                                                                                <div style="margin-right:-2%" class="d-flex justify-content-end mt-2">
                                                                                                                    <a href="#"
                                                                                                                        ...
                                                                                                                        &nbsp;
                                                                                                                        <small class="me-2 d-none d-sm-inline-block">Balas</small>
                                                                                                                    </a>
                                                                                                                </div>
                                                                                                                </div>
                                                                                                        </div>
                                                                                                                            ...
                                                                                                                            <form
                                                                                                                                    ...
                                                                                                                                    <div class="row mb-3">
                                                                                                                                        <div class="col-lg-1 col-md-1 col-2 pl-1">
                                                                                                                                            @if (Auth::user()->foto)
                                                                                                                                                <img src="{{ asset('storage/' . Auth::user()->foto) }}"
                                                                                                                                                    class="border rounded-circlefoto-responsive"
                                                                                                                                                    alt="Avatar"
                                                                                                                                                    style="height: 40px;" />
                                                                                                                                            @else
                                                                                                                                                <img src="{{ asset('images/default.jpg') }}"
                                                                                                                                        ...
                                                                                                                                        <div
                                                                                                                                            ...
                                                                                                                                            <input
                                                                                                                                                ...
                                                                                                                                                name="komentar"
                                                                                                                                                style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); width: 100%; border-radius:30px;"
                                                                                                                                                class="form-control border border-dark border-5 me-3 mt-1"
                                                                                                                                                placeholder="Masukkan komentar...">
                                                                                                                                        </div>
              ...
              let innerHtml = `
                            <div class="media row mb-2" id="komen_veed_ini${up['id']}"
                                                                        ...
                                                                        <div style="margin-top:-2%;" class="">
                                                                            <div class="d-flex komentar1">
                                                                                <p class="text-deskripsi">${up['komentar']}</p>
                                                                            </div>
                                                                            <div class="d-flex col-lg-12 pr-0"
                                                                                style="margin-top:-3%;">
                                                                                <div class="d-flex icon-komentar1">
                                                                                    @if (Auth::user())
                                                                                            <form
                                                                                    ...
                                                                                    @else
                                                                                        <img src="{{ asset('images/🦆 icon _thumbs up_.svg') }}"
                                                                                            ...
                                                                                            alt="" class="me-3" style="margin-left: 40%;">
                                                                                    @endif
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <form
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="col-lg-9 col-md-9 col-7 pl-1">
                                                                                                            <input
                                                                                                                type="text"
