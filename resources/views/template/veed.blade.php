...
@section('content')
                                    ...
                                    <a href="" class="col-lg-1 col-md-1 col-2 pr-3 pl-1">
                                        @if ($item_video->user->foto)
                                            <img src="{{ asset('storage/' . $item_video->user->foto) }}"
                                                class="border rounded-circle me-2 foto-responsive" alt="Avatar"
                                                style="height: 40px" />
                                        @else
                                        ...
                                        <span class="d-flex flex-row" style="color: black;">
                                            ...
                                            @if (Auth::check())
                                                ...
                                                @if ($item_video->checkLikeFeed(Auth::user()->id))
                                                    <form id="formLikeVeed{{ $urut }}"
                                                        ...
                                                        <span style="vertical-align: middle; font-size: xxx-small;"
                                                ...
                                                @else
                                                    <form id="formLikeVeed{{ $urut }}"
                                                        ...
                                                        <button class="text-dark pr-0 pl-0"
                                                            ...
                                                            onclick="likeFeed({{ $urut }})">
                                                            <i id="likeB{{ $urut }}"
                                                                class="fa-regular fa-lg fa-thumbs-up"
                                                                style="font-size: large;"></i>
                                                        </button>
                                                        <span style="vertical-align: middle; font-size: xxx-small;"
                                                            class="my-auto ml-auto"
                                            ...
                                            @else
                                                <form class="text-center mr-1">
                                                    <button
                                                        style="border: none; background-color:white; margin-bottom: 2px;"
                                                        id="buttonLikeVeed" type="button" onclick="harusLogin()"
                                                        class="pr-0" style="margin-bottom: 1px;">
                                                        <i class="fa-regular fa-lg fa-thumbs-up"
                                                            style="font-size: large;"></i>
                                                    </button>
                                                    <span style="vertical-align: middle; font-size: xxx-small"
                                                        class="my-auto ml-auto"
                                            ...
                                            <!-- Bagikan feed start -->
                                            <a class="ml-1 mr-1 my-auto text-dark text-center" href="#"
                                                data-bs-toggle="modal" data-bs-target="#bagikan{{ $item_video->id }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="20"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body mb-4 px-3">
                                                                <div class="  row align-items-center">
                                                                    ...
                                                                    <div class="search col-lg-9 col-10 col-md-7 pl-md-2"
                                        ...
                                        <span class="d-flex" style="float: right;">
                                            ...
                                            @else
                                                <a type="button" data-bs-toggle="modal"
                                                    ...
                                                    <i class="fa-solid fa-coins fa-lg my-auto me-1 ms-3"
                                                        style="font-size: 13pt;"></i>
                                                </a>
                                                            ...
                                                            <div class="modal-body p-4 col-12">
                                                                <div class="row">
                                                                    ...
                                                                    <label for="moreInput"
                                                                        class="col-lg-3 col-md-6 col-12 my-1 ">
                                                                        <button type="button"
                                                                            class="card border-2 scale border-black"
                                                                            onclick="more_gift_click({{ $item_video->id }})"
                                                                            id="moreGift{{ $item_video->id }}"
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="row mt-4">
                                                                        <div
                                                                            class="col-lg-5 col-md-6 col-12 pl-0 removePadding1">
                                                                            <input type="number"
                                                                                id="moreInput{{ $item_video->id }}"
                                                                        ...
                                                                        <div
                                                                            class="col-lg-2 col-md-12 col-12 pr-0 pl-0 penempatan-button">
                                                                            <button type="submit"
                                                    ...
                                                    @if (Auth::user()->role != 'admin' && $item_video->user->role != 'admin' && Auth::user()->id !== $item_video->user->id)
                                                        ...
                                                        <button type="button" data-bs-toggle="modal"
                                                            ...
                                                            style=" vertical-align: middle;"><i
                                                                class="fa-solid fa-xl mt-1 fa-triangle-exclamation mt-1"
                                                                style="font-size: 13pt; "></i>
                                                        </button>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="submit"
                                                                                id="ButtonReportFeed{{ $item_video->id }}"
                                                                            ...
                                                                            <button type="submit"
                                                                                id="ButtonReportFeed2{{ $item_video->id }}"
                                                                                onclick="ReportFeed({{ $item_video->id }})"
                                                ...
                                                style="border-radius: 15px; background-color:#F7941E;"><b
                                                  class="ms-2 me-2">Blokir</b></button>
                                                        ...
                                                        <div class="modal fade p-0"
                                                            id="blocksModal{{ $item_video->id }}" tabindex="-1"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <button type="button" class="btn-close"
                                                                            ...
                                                                            id="ButtonDismissBlockFeed{{ $item_video->id }}"
                                                                            data-dismiss="modal"
                                                                            aria-label="Close"></button>
                                                                    </div>
                                                                    <form action="admin/block-feed/{{ $item_video->id }}"
                                                                        method="POST"
                                                                        ...
                                                                        <div class="row col-12 mb-3 pr-0 mt-3">
                                                                            <div
                                                                                ...
                                                                                <img class="img-fluid foto-modal"
                                                                                    src="{{ asset('images/alasan.png') }}"
                                                                                    width="100%" alt="">
                                                                            </div>
                                                                            <div
                                                                                class="col-lg-8 col-md-12 align-items-center pr-0">
                                            ...
                                            <div class="modal-content" style="width: 100%;">
                                                ...
                                                @else
                                                    ...
                                                    <button type="button" onclick="harusLogin()"
                                                        class="yuhu text-dark btn-sm rounded-5 "
                                                        style="vertical-align: middle;"><i
                                                            class="fa-solid fa-xl fa-triangle-exclamation mt-1"
                                                            style="font-size: 13pt;"></i>
                                                    </button>
                                                @endif
                                                {{-- --}}
                                ...
                                <div class="d-flex mb-3">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <p style="max-width: 100%;" class="p-0 text-deskripsi">
                                                {{ $item_video->deskripsi_video }}</p>
                                            <!-- </div> -->
                                            <div class="collapse p-0" style="margin-top: -2%;"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="">
                                                        <div class="row">
                                                            ...
                                                            @endif
                                                            <div id="new_komentar_feed{{ $item_video->id }}"
                                                                class="pl-0"></div>
                                                                ...
                                                                @foreach ($item_video->comment_veed->sortByDesc('created_at') as $nomer => $item_comment)
                                                                    <div class="media row mb-2"
                                                                        ...
                                                                        <div class="d-flex col-12">
                                                                            ...
                                                                            @endif
                                                                            <p
                                                                                class="ms-2 mb-2 fw-bolder ellipsis-name text-deskripsi">
                                                                        ...
                                                                        <div style="margin-top: -2%;">
                                                                            <div class="d-flex pt-0  komentar1">
                                                                                <p
                                                                                    class="text-truncate ellipsis-name text-deskripsi">
                                                                                            ...
                                                                                            <div class="modal fade"
                                                                                                ...
                                                                                                <div class="modal-dialog modal-dialog-centered"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <form
                                                                                                            id="FormLaporkanKomentarUtama{{ $item_comment->id }}"
                                                                                                ...
                                                                                                <div class="modal-dialog modal-dialog-centered"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <button
                                                                                                               id="ButtonDismissBlokirKomentar{{$item_comment->id}}"
                                                                                                                type="button"
                                                                                                                class="close"
                                                                                                                data-bs-dismiss="modal"
                                                                                                                data-bs-target="blockMod{{ $item_comment->id }}"
                                                                                                        ...
                                                                                                        <form
                                                                                                            action="{{ route('block.comment.feed', $item_comment->id) }}"
                                                                                                            id="FormBlokirKomentar{{ $item_comment->id }}"
                                                                                                            method="POST">
                                                                                                            @csrf
                                                                                                            @method('PUT')
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    class="col-lg-9 col-md-12 col-12 pr-0">
                                                                                                                    <textarea class="form-control rounded-5" style="border-radius: 15px" name="alasan"
                                                                                                                        id="AlasanBlokirKomentar{{ $item_comment->id }}" rows="5" placeholder="Alasan..."></textarea>
                                                                                                                </div>
                                                                                                                {{-- @endif --}}
                                                                                                            </div>
                                                                                                            <div
                                                                                                                ...
                                                                                                                <button
                                                                                                                    type="submit"
                                                                                                                    id="ButtonBlokirKomentar{{ $item_comment->id }}"
                                                                                                                    onclick="BlokirKomentar({{ $item_comment->id }})"
                                                                                                                    class="btn btn-light text-light d-none d-sm-inline-block"
                                                                                                                    style="border-radius: 15px; background-color:#F7941E;"><b
                                                                                                                        class="ms-2 me-2">Blokir</b></button>
                                                                                ...
                                                                                <div style="margin-right:-2%;"
                                                                                    ...
                                                                                    @if ($item_comment->count_replies() > 0)
                                                                                        <a href="#"
                                                                                            ...
                                                                                            &nbsp; <small
                                                                                                class="d-none d-sm-inline-block">Tampilkan
                                                                                    ...
                                                                                    @else
                                                                                        <a href="#"
                                                                                            ...
                                                                                            &nbsp; <small
                                                                                                class="d-none d-sm-inline-block">Balas</small>
                                                                                        </a>
                                                                                    @endif
                                                                                </div>
                                                                            </div>
                                                                                            ...
                                                                                            @if (Auth::check())
                                                                                                <form
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="col-xl-9 col-lg-8 col-md-9 col-7 pl-1">
                                                                                                            <input
                                                                                                                type="text"
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="col-xl-2 col-lg-3 col-md-2 col-3 p-0">
                                                                                            ...
                                                                                            @else
                                                                                                <form>
                                                                                                    <div class="row mb-3">
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="col-lg-2 col-md-2 col-3 p-0">
                                                                                                            <button
                                                                                                                type="button"
                                                                                                                id="buttonCommentVeed"
                                                                                                                onclick="harusLogin()"
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <span
                                                                                                                    class="d-flex">
                                                                                                                    <p
                                                                                                                        class="fw-bolder mb-2 ellipsis-name text-deskripsi">
                                                                                                            ...
                                                                                                            <div
                                                                                                                        ...
                                                                                                                        @if (Auth::user())
                                                                                                                            ...
                                                                                                                            @elseif(Auth::user()->role == 'admin')
                                                                                                                                ...
                                                                                                                                <button
                                                                                                                                    type="button"
                                                                                                                                    data-toggle="modal"
                                                                                                                                    data-target="#blockModale{{ $reply_comment->id }}"
                                                                                                                                    class="yuhu text-danger btn-sm rounded-5 "><svg
                                                                                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                                                                                        width="20"
                                                                                                                                        height="20"
                                                                                                                                ...
                                                                                                                                <div class="modal fade"
                                                                                                                                    ...
                                                                                                                                    <div class="modal-dialog modal-dialog-centered"
                                                                                                                                        ...
                                                                                                                                        <div
                                                                                                                                            ...
                                                                                                                                            <form
                                                                                                                                                action="{{ route('block.reply.comment.feed', $reply_comment->id) }}"
                                                                                                                                                id="FormBlokirKomen{{ $reply_comment->id }}"
                                                                                                                                                method="POST">
                                                                                                                                                @csrf
                                                                                                                                                @method('PUT')
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div
                                                                                                                                                        class="col-lg-9 col-md-12 col-12 pr-0">
                                                                                                                                                        <textarea class="form-control rounded-5" style="border-radius: 15px" name="alasan"
                                                                                                                                                            id="AlasanBlokirKomen{{ $reply_comment->id }}" rows="5" placeholder="Alasan..."></textarea>
                                                                                                                                                    </div>
                                                                                                                                                    {{-- @endif --}}
                                                                                                                                                </div>
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <button
                                                                                                                                                        type="submit"
                                                                                                                                                        id="ButtonBlokirKomen{{ $reply_comment->id }}"
                                                                                                                                                        onclick="BlokirKomen({{ $reply_comment->id }})"
                                                                                                                                                        class="btn btn-light text-light d-none d-sm-inline-block"
                                                                                                                                                        style="border-radius: 15px; background-color:#F7941E;"><b
                                                                                                                                                            class="ms-2 me-2">Blokir</b></button>
                                                                                                                ...
                                                                                                                <div style="margin-right:-2%"
                                                                                                                    ...
                                                                                                                    <a href="#"
                                                                                                                        ...
                                                                                                                        &nbsp;
                                                                                                                        <small
                                                                                                                            class="me-1 d-none d-sm-inline-block">Balas</small>
                                                                                                                    </a>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                    ...
                                                                                                    @foreach ($reply_comment->balasRepliesCommentsFeeds as $nomers => $reply_replyComment)
                                                                                                        <div id="balasan_komentar_ini2{{ $reply_replyComment->id }}"
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div class="d-flex icon-komentar2"
                                                                                                                    style="margin-top: -3%;">
                                                                                                                    <div
                                                                                                                                            ...
                                                                                                                                            <div
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <button
                                                                                                                                                        type="button"
                                                                                                                                                        class="close"
                                                                                                                                                        id="ButtonDiss{{$reply_replyComment->id}}"
                                                                                                                                                        data-bs-dismiss="modal"
                                                                                                                                                ...
                                                                                                                                                <form
                                                                                                                                                    action="{{ route('block.reply.reply.comment.feed', $reply_replyComment->id) }}"
                                                                                                                    ...
                                                                                                                    <div style="margin-right:-2%"
                                                                                                                        ...
                                                                                                                        <a href="#"
                                                                                                                            ...
                                                                                                                            &nbsp;
                                                                                                                            <small
                                                                                                                                class="me-3 d-none d-sm-inline-block">Balas</small>
                                                                                                                        </a>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                                ...
                                                                                                                @else
                                                                                                                    <form>
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                class="col-xl-9 col-lg-7 col-md-9 col-7 pl-1">
                                                                                                                                <input
                                                                                                                                    type="text"
                                                                                                                                    id="inputKomentarBalasan{{ $reply_comment->id }}"
                                                                                                                                    name="commentVeed"
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                class="col-xl-2 col-lg-4 col-md-2 col-3 p-0">
                                    ...
                                    <div>
                                        <div class="bg-light rounded-3 px-3 py-1">
                                            <a href="/artikel/{{ $resep->id }}/{{ $resep->nama_resep }}"
                                                ...
                                                <div class="pl-0 pr-0 d-flex">
                                                    <strong
                                                        class="ellipsis-menu">{{ explode(' ', $resep->user->name)[0] }}</strong>
                                                    @if ($resep->user->isSuperUser == 'yes')
                                                        <i
                                                            class="fa-regular fa-sm text-primary fa-circle-check my-auto ms-2"></i>
                                                    @endif
                                                </div>
    ...
    <button type="button" data-dismiss="modal" id="TutupModal" hidden></button>
    <script>
        function limitName() {
            let elements = document.querySelectorAll('.ellipsis-name');
        ...
        // function-function blokir admin
            ...
            $("#FormBlokirKomentar" + num).submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function success(response) {
                        ...
                        $("#ButtonDismissBlokirKomentar" + num).click();
                        $("#komen_veed_ini" + num).css("display", "none");
                    },
                    error: function error(xhr, error, status) {
                        iziToast.destroy();
                        iziToast.error({
            ...
            $("#FormBlokirReplyCommentFeed" + num).submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function success(response) {
                        ...
                        $('#balasan_komentar_ini2'+num).css("display", "none");
                        $("#ButtonDiss"+num).click();
                    },
                    error: function error(xhr, error, status) {
                        iziToast.destroy();
                        iziToast.error({
            ...
            $("#FormBlockFeed" + num).submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function success(response) {
                        ...
                        $("#ButtonDismissBlockFeed" + num).click();
                    },
                    error: function error(xhr, error, status) {
                        iziToast.destroy();
                        iziToast.error({
