    ...
    <div class="container-fluid py-5">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <ul class="nav text-sm ulLaptop" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation" hidden>
                                <button id="a-tab2" class="nav-link mr-5 yuhu mt-2" id="pills-footer-tab"
                                ...
                                <form action="{{ route('kursus') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select style="border: 1px solid black" name="jenis_kursus[]"
                                            aria-placeholder="Masukkan jenis kursus" multiple="multiple" id="kursus"
                                        ...
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="d-flex justify-content-center mx-auto">
                                                    <input type="text" name="min_time" class="form-control mr-1"
                                                        placeholder="Minimal"
                                                        style="border-radius: 5px; font-size:13px;border: 1px solid black;">
                                            ...
                                            <div class="col-5">
                                                <div class="d-flex justify-content-center mx-auto">
                                                    <input type="text" name="max_time" class="form-control mr-1"
        ...
        <div class="mx-4">
            <div class="tab-content mb-5 mx-1 my-5" id="pills-tabContent">
                        ...
                        @foreach ($semua_kursus as $semua)
                            <div class=" col-lg-4 col-md-4 col-sm-5 mb-4">
                                <div class="card " style="border-radius:15px">
                                    <img src="{{ asset('storage/' . $semua->foto_kursus) }}" class="imgku"
                                        alt="...">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 mt-3 row">
                                                <div class="col-6 d-flex">
                                                    ...
                                                    <p class="mt-1 mx-1"> {{ $semua->jumlah_sesi() }} Sesi</p>
                                                </div>
                                                <div class="col-6 d-flex">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                        viewBox="0 0 15 15">
                                                        ...
                                                        <p class="mt-1 mx-1">{{ $semua->total_waktu_sesi() }}</p>
                                                    </svg>
                                                </div>
                                            </div>
                                        </div>
                ...
                {{-- start tab 2 --}}
                <div class="tab-pane courses fade" id="pills-profile" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mt-3 row">
                                            <div class="col-6 d-flex">
                                                ...
                                                <p class="mt-1 mx-1">{{ $baru->jumlah_sesi() }}</p>
                                            </div>
                                            <div class="col-6 d-flex">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                    viewBox="0 0 15 15">
                                                    <path fill="none" stroke="currentColor"
                                                        d="M7.5 5v3.5H10m-4-8h3m-1.5 2a6 6 0 1 0 0 12a6 6 0 0 0 0-12Z" />
                                                    <p class="mt-1 mx-1">{{ $baru->total_waktu_sesi() }}</p>
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
                ...
                {{-- start tab 3 --}}
                <div class="tab-pane courses fade" id="pills-contact" role="tabpanel"
                    ...
                    <div class="row mx-1" style="margin-left: -50px">
                        @foreach ($kursus_terfavorite as $terfavorite)
                            <div class="card mx-3 mb-5" style="width: 30%; border-radius:15px">
                                <img src="{{ asset('storage/' . $terfavorite->foto_kursus) }}" class="card-img-top"
                                    style="margin-left:-13px; width:107.5%; border-top-left-radius: calc(0.5rem - 1px);
                               border-top-right-radius: calc(0.5rem - 1px);"
                                    alt="...">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <a href="{{ route('detail.kursus', $terfavorite->id) }}" class="btn"
                                                style="font-family: poppins;font-weight:bold">{{ $terfavorite->nama_kursus }}</a>
                                        </div>
                                        <div class="col-12 mt-3 row">
                                            <div class="col-6 d-flex">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                ...
                                                <p class="mt-1 mx-1"> {{ $terfavorite->jumlah_sesi() }} Sesi</p>
                                            </div>
                                            <div class="col-6 d-flex">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                    viewBox="0 0 15 15">
                                                    <path fill="none" stroke="currentColor"
                                                        d="M7.5 5v3.5H10m-4-8h3m-1.5 2a6 6 0 1 0 0 12a6 6 0 0 0 0-12Z" />
                                                    <p class="mt-1 mx-1">{{ $terfavorite->total_waktu_sesi() }}</p>
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
                ...
                {{-- start tab 4 --}}
                <div class="tab-pane courses fade" id="pills-terbaik" role="tabpanel"
                    aria-labelledby="pills-terbaik-tab" tabindex="0">
