                                    ...
                                    <span class="d-flex flex-row" style="color: black;">
                                        ...
                                        @if (Auth::check())
                                            <div id="feed{{ $item_video->id }}">
                                                ...
                                                @endphp
                                                @if ($isLikeVeed == 0)
                                                    <form id="formLikeVeed{{ $item_video->id }}"
                                                        action="/like/veed/{{ Auth::user()->id }}/{{ $item_video->id }}">
                                                        <button class="text-dark me-1"
                                                            style="border: none; background-color:white;"
                                                            onclick="likeFeed({{ $item_video->id }})">
                                                            <i id="likeB{{ $item_video->id }}"
                                        ...
                                        @endif
                                        <span class="my-auto"
                                            id="countLikeFeed{{ $item_video->id }}">{{ $countLikeVeed }}</span>
                                        <!-- like feed end -->
                                        <!-- komentar feed start -->
                                        <a type="button" class="ms-3 text-dark"
                                            onclick="openModel({{ $item_video->id }})"
                                            id="button-modal-komentar-feed{{ $item_video->id }}" href="#"
                                            data-bs-toggle="modal"data-bs-target="#exampleModal{{ $item_video->id }}">
                                        ...
                                        <!-- modal komentar feed -->
                                        <div class="modal" id="exampleModal{{ $item_video->id }}">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body d">
                                                        ...
                                                        @if (Auth::user())
                                                            <form id="formCommentVeed{{ $item_video->id }}"
                                                                ...
                                                                <div class="d-flex mb-3">
                                                                    ...
                                                                    @endif
                                                                    <input type="text"
                                                                        id="input_comment_feed{{ $item_video->id }}"
                                                                    ...
                                                                    <button type="submit"
                                                                        id="buttonCommentVeed{{ $item_video->id }}"
